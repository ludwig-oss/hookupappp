...
export const CHAT_CHALLENGES = [
  ...
  { type: 'hot-seat', name: 'Hot Seat', description: 'Bold-but-kind Q&A rounds' },
  { type: 'rose-bud-thorn', name: 'Rose Bud Thorn', description: 'Share highs, growth, lows' },
  { type: 'five-favorites', name: 'Five Favorites', description: 'Rapid-fire favorites' },
  { type: 'dealbreakers', name: 'Soft Dealbreakers', description: 'Share light dating icks' },
  { type: 'bucket-list-blitz', name: 'Bucket List Blitz', description: 'Share year goals' },
  { type: 'time-travel', name: 'Time Travel', description: 'Advice to your younger self' },
  { type: 'superpower-trade', name: 'Superpower Trade', description: 'Pick a one-day power' },
  { type: 'desert-island', name: 'Desert Island', description: 'Three items only' },
  { type: 'first-date-remix', name: 'First Date Remix', description: 'Upgrade a boring date' },
  { type: 'text-charades', name: 'Text Charades', description: 'Act titles with emojis' },
  { type: 'yes-and', name: 'Yes And', description: 'Improv story building' },
  { type: 'values-lightning', name: 'Values Lightning', description: 'Rank what matters' },
  { type: 'secret-menu', name: 'Secret Menu', description: 'Invent a date special' },
  { type: 'playlist-duel', name: 'Playlist Duel', description: 'Trade three songs each' },
  { type: 'caption-this', name: 'Caption This', description: 'Caption a shared moment' },
  { type: 'future-postcard', name: 'Future Postcard', description: 'Write from one year ahead' },
  { type: 'compliment-volley', name: 'Compliment Volley', description: 'Specific compliments only' },
  { type: 'tiny-wins', name: 'Tiny Wins', description: 'Share a win from today' },
  { type: 'mystery-box', name: 'Mystery Box', description: 'Guess what’s in the box' },
];
